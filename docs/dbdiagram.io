...
Table TmcCode [note: "Справочник [ТМЦ]"] {
  ...
  MigrationId int [ note: "Идентификатор номера итерации миграции"]
  RxId        bigint          [note: "Идентификатор в системе DRX"]
  Name nvarchar(500) [not null, note: "Наименование"]
  Code nvarchar(20) [not null, note: "Код ТМЦ"]
...
Table OkvedCode [note: "Справочник [ОКВЭД]"] {
  ...
  RxId        bigint          [note: "Идентификатор в системе DRX"]
  Name nvarchar(500) [not null, note: "Наименование"]
  Code nvarchar(20) [not null, note: "Код ОКВЭД"]
...
Table Division [note: "Справочник [Дивизионы]"] {
  ...
  PortalId nvarchar(50) [note: "Идентификатор на портале"]
...
Table DocumentKind [note: "Справочник [Виды документов]"] {
  ...
  ParentDocumentKindPaydoxId nvarchar(150) [note: "Идентификатор в системе PayDox на родительский вид документа"]
...
// Справочник "Способы доставки"
Table DeliveryMethod [note: "Справочник [Способы доставки]"] {
  Id bigint [pk, increment]
  PaydoxId  nvarchar(150)  [not null, note: "Идентификатор в системе PayDox"]
  MigrationId int [ note: "Идентификатор номера итерации миграции"]
  RxId        bigint          [note: "Идентификатор в системе DRX"]
...
Table Document [note: "Таблица [Документы]"] {
  ...
  AdditionalAmount float [note: "Доп сумма"]
