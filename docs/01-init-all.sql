...
INSERT INTO dbo.Document (Id, DocType, Name, ДругиеПоля, CountryId, AuthorId, Note) VALUES
-- Простые документы
(N'OU001:DOC:2026-001', N'Простой документ', N'Простой документ №П-001/24', N'{"номер":"П-001","дата":"2024-01-15","сумма":0}', N'OU001:CTR:RU', N'OU001:EMP:00001', N'О назначении комиссии'),
(N'OU001:DOC:2026-002', N'Простой документ', N'Простой документ №ДГ-002/24', N'{"номер":"ДГ-002","дата":"2024-01-20","сумма":500000}', N'OU001:CTR:RU', N'OU001:EMP:00007', N'Договор поставки оборудования'),
(N'OU001:DOC:2026-003', N'Простой документ', N'Простой документ №АКТ-003/24', N'{"номер":"АКТ-003","дата":"2024-02-01","сумма":500000}', N'OU001:CTR:RU', N'OU001:EMP:00007', N'Акт выполненных работ'),

(N'OU001:DOC:2024-001', N'Приказ', N'Приказ №П-001/24', N'{"номер":"П-001","дата":"2024-01-15","сумма":0}', N'OU001:CTR:RU', N'OU001:EMP:00001', N'О назначении комиссии'),
(N'OU001:DOC:2024-002', N'Договор', N'Договор №ДГ-002/24', N'{"номер":"ДГ-002","дата":"2024-01-20","сумма":500000}', N'OU001:CTR:RU', N'OU001:EMP:00007', N'Договор поставки оборудования'),
(N'OU001:DOC:2024-003', N'Акт', N'Акт №АКТ-003/24', N'{"номер":"АКТ-003","дата":"2024-02-01","сумма":500000}', N'OU001:CTR:RU', N'OU001:EMP:00007', N'Акт выполненных работ'),
(N'OU001:DOC:2024-004', N'Служебная записка', N'Служебная записка №СЗ-004/24', N'{"номер":"СЗ-004","дата":"2024-02-05","сумма":0}', N'OU001:CTR:RU', N'OU001:EMP:00004', NULL),
(N'OU001:DOC:2024-005', N'Протокол', N'Протокол №ПР-005/24', N'{"номер":"ПР-005","дата":"2024-02-10","сумма":0}', N'OU001:CTR:RU', N'OU001:EMP:00001', N'Протокол заседания правления'),
(N'OU001:DOC:2024-006', N'Положение', N'Положение №ПЛЖ-006/24', N'{"номер":"ПЛЖ-006","дата":"2024-02-15","сумма":0}', N'OU001:CTR:RU', N'OU001:EMP:00005', N'Положение о премировании'),
(N'OU001:DOC:2024-007', N'Отчет', N'Отчет №ОТЧ-007/24', N'{"номер":"ОТЧ-007","дата":"2024-02-20","сумма":0}', N'OU001:CTR:RU', N'OU001:EMP:00002', N'Финансовый отчет за январь'),
(N'OU001:DOC:2024-008', N'Заявка', N'Заявка №ЗВК-008/24', N'{"номер":"ЗВК-008","дата":"2024-02-25","сумма":150000}', N'OU001:CTR:RU', N'OU001:EMP:00003', NULL),
(N'OU001:DOC:2024-009', N'Счет', N'Счет №СЧ-009/24', N'{"номер":"СЧ-009","дата":"2024-03-01","сумма":250000}', N'OU001:CTR:RU', N'OU001:EMP:00007', NULL),
(N'OU001:DOC:2024-010', N'Письмо', N'Письмо №ПСМ-010/24', N'{"номер":"ПСМ-010","дата":"2024-03-05","сумма":0}', N'OU001:CTR:US', N'OU001:EMP:00001', N'Письмо партнерам');
GO
